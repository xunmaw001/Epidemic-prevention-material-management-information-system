...
var indexNav = [
    ...
    {
        name: '物资',
        url: './pages/fangyiwuzi/list.html'
    },
    {
        name: '论坛',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/fangyiwuzhiguanli/admin/dist/index.html#/login";
